...
export const Modal = () => {
  return (
    <div className="h-screen">
      <div className="inline-flex justify-center mx-auto w-full pt-60">
      ...
      <button className="flex mx-auto text-white mt-80 bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
